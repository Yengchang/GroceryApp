// ignore_for_file: avoid_print, unnecessary_null_comparison, use_build_context_synchronously, prefer_if_null_operators
...
class _UserScreenState extends State<UserScreen> {
  ...
  @override
  void initState() {
    getUserData(); //used getdata function
    super.initState();
  }

//this function to get data from firebase
                  ...
                  RichText(
                    text: TextSpan(
                      ...
                      children: <TextSpan>[
                        TextSpan(
                            text: _name ??
                                'User', // if _name = null than show 'User'
                            style: TextStyle(
                                color: color,
